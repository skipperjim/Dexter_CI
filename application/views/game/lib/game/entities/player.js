...
.requires(
    ...
    .defines(function(){
        EntityPlayer = ig.Entity.extend({
            animSheet: new ig.AnimationSheet('/assets/media/game/player.png', 16, 16),
            jumpSFX: new ig.Sound('/assets/media/game/sounds/jump.*'),
            shootSFX: new ig.Sound('/assets/media/game/sounds/shoot.*'),
            deathSFX: new ig.Sound('/assets/media/game/sounds/death.*'),
            size: {x: 8, y:14},
            offset: {x: 4, y: 2},
            flip: false,
            maxVel: {x: 100, y: 150},
        ...
        EntityBullet = ig.Entity.extend({
           size: {x: 5, y: 3},
            animSheet: new ig.AnimationSheet('/assets/media/game/bullet.png', 5, 3),
            maxVel: {x: 200, y: 0},
        ...
        EntityGrenade = ig.Entity.extend({
           size: {x: 4, y: 4},
            offset: {x: 2, y: 2},
            animSheet: new ig.AnimationSheet('/assets/media/game/grenade.png', 8, 8),
            type: ig.Entity.TYPE.NONE,
        ...
        EntityDeathExplosionParticle = ig.Entity.extend({
           size: {x: 2, y: 2},
            ...
            colorOffset: 0,
            totalColors: 7,
            animSheet: new ig.AnimationSheet('/assets/media/game/blood.png', 2, 2),
            init: function(x, y, settings){
                this.parent(x, y, settings);
        ...
        EntityGrenadeParticle = ig.Entity.extend({
            ...
            checkAgainst: ig.Entity.TYPE.B,
            collides: ig.Entity.COLLIDES.LITE,
            animSheet: new ig.AnimationSheet('/assets/media/game/explosion.png', 1, 1),
            init: function(x, y, settings){
                this.parent(x, y, settings);
