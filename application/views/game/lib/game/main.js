...
MyGame = ig.Game.extend({
    ...
    showStats: false,
    statMatte: new ig.Image('/assets/media/game/stat-matte.png'),
    levelTimer: new ig.Timer(),
    levelExit: null,
    lives: 3,
    stats: {time: 0, kills: 0, deaths: 0},
    instructText: new ig.Font('/assets/media/game/04b03.font.png'),
    lifeSprite: new ig.Image('/assets/media/game/life-sprite.png'),
	init: function() {
...
GameOverScreen = ig.Game.extend({
   instructText: new ig.Font('/assets/media/game/04b03.font.png'),
    background: new ig.Image('/assets/media/game/screen-bg.png'),
    gameOver: new ig.Image('/assets/media/game/game-over.png'),
    stats: {},
    init: function(){
        ig.input.bind(ig.KEY.SPACE, 'start');
